...
#ifdef CHASER_U8G_SDL
U8GLIB u8g(&u8g_dev_sdl_2bit);
#else
//U8GLIB_SSD1306_128X64 u8g(U8G_I2C_OPT_NONE|U8G_I2C_OPT_DEV_0);	// I2C / TWI
U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_DEV_0|U8G_I2C_OPT_NO_ACK|U8G_I2C_OPT_FAST);	// Fast I2C / TWI
#endif
...
void loop() {
  ...
  do {
    u8g.setColorIndex(1);
    u8g.drawBox(0,0, display_width,display_height);
    ...
    for (uint8_t d=0; d<NUMCHASER; d++) {
      ...
      u8g.setColorIndex(0);
      u8g.drawBitmapP( c->x, c->y, cimg->width>>3, cimg->height, cimg->msk );

      u8g.setColorIndex(1);
      u8g.drawBitmapP( c->x, c->y, cimg->width>>3, cimg->height, cimg->btm );
